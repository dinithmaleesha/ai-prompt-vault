...
```json
{
  ...
  "environment": {
    ...
    "room_details": {
      ...
      "lights": "LED strip lights on wall",
  ...
  "vibe": {
    ...
    "caption": "'fit check' or 'staying in' or '🤍'"
  }
}
```
---
...
```json
{
  "subject": {
    ...
    "clothing": {
      "top": {
        "type": "Blake ribbed tank top",
        "fit": "fitted, cropped above belly button",
        "neckline": "scoop neck, simple",
        "effect": "basic but shows shape"
      },
      "bottom": {
        "type": "White cotton boy shorts / mini shorts",
        "fit": "tight, very short, sits low on hips",
        "style": "lounge shorts, underwear-adjacent",
        "effect": "barely there, shows legs completely"
      }
...
```json
{
  ...
  "outfit": {
    "bodysuit": "form-fitting black symbiote-inspired superhero bodysuit with subtle dark web texturing",
...
{
  "subject": {
    "description": "Young woman in car passenger seat at night, cozy tired energy, that 'drive me home' vibe",
    "age": "early 20s",
    
    "expression": {
      "eyes": "soft, slightly tired, looking directly at camera, doe eyes",
      "mouth": "soft relaxed pout, lips slightly parted",
      "overall": "that 'im tired but still cute' late night energy"
    },
    
    "hair": {
      "color": "platinum blonde with subtle pink tint",
      "style": "messy, tousled, falling naturally",
      "details": "pushed to one side, bedhead vibes"
    },
    
    "body": {
      "position": "reclined in passenger seat",
      "legs": "pulled up, knees to chest, curled up",
      "frame": "petite, cozy, compact pose"
    },
    
    "pose": {
      "position": "sitting sideways in passenger seat, back against door/seat",
      "legs": "bent, knees up, feet on seat, hugging legs",
      "arms": "one arm extended taking photo, other hand resting on leg",
      "head": "tilted against headrest, relaxed",
      "overall": "the curled up passenger seat pose"
    },
    
    "clothing": {
      "top": {
        "type": "cream/beige cropped cable knit sweater",
        "fit": "fitted, cropped showing sliver of midriff",
        "sleeves": "long, cozy"
      },
      "bottom": {
        "type": "dark grey leggings/yoga pants",
        "fit": "tight, second skin, full length"
      },
      "jacket": {
        "type": "olive/khaki bomber or utility jacket",
        "status": "draped behind her, not fully worn"
      },
      "feet": "barefoot, shoes off in car"
    },
    
    "accessories": {
      "earrings": "small studs, minimal",
      "minimal": "cozy night out, not overdone"
    }
  },

  "environment": {
    "location": "car passenger seat, nighttime",
    "car_interior": {
      "seats": "tan/beige leather",
      "vibe": "nice car, comfortable"
    },
    "outside": {
      "visible": "city lights through window, neon signs",
      "signs": "bowling lanes sign visible, urban area",
      "weather": "night, possibly rainy (wet window)"
    },
    "lighting": "mixed - soft interior, neon glow from outside"
  },

  "photography": {
    "style": "selfie from driver perspective or self-timer",
    "framing": "full body curled in seat",
    "quality": "iPhone, nighttime",
    "aspect": "4:5 vertical"
  },

  "color_story": {
    "her": "cream sweater, grey leggings, platinum hair",
    "car": "tan leather, warm interior",
    "outside": "neon reds and blues through glass",
    "mood": "warm inside vs cool city outside"
  },

  "vibe": {
    "energy": "cozy, tired, end of night",
    "mood": "'take me home' passenger princess",
    "caption": "'late night drives' or 'passenger princess' or '🚗'"
  }
}
```
---
...
```json
{
  ...
  "scene": {
    "location": "hot yoga studio",
    "setting": "mats on floor, mirrored walls fogged, incense haze",
    "time": "late afternoon",
  ...
  "lighting": {
    "type": "warm ambient",
    "source": "studio lights dimmed + window sunlight",
    "effect": "sweat highlights, toned shadows"
  },

  "camera_perspective": {
    "pov": "we ARE her phone",
    "angle": "low from floor level",
    "distance": "arm-length",
  ...
  "subject": {
    ...
    "pose": {
      "position": "in child's pose variation",
  ...
  "details": [
    "fogged mirrors",
    "sweat puddles on mat",
    "yoga props scattered",
    "post-flow glow",
